// Shared Project Manager Studio API contract. The server owns facts; the
// client owns only transient filtering and edit-form state.
...
export interface KanbanData {
  ...
  project: { id: string; name: string; root: string; status: string; owner: string | null; objective: string; target_date: string | null; current_milestone: string | null; profile: string };
